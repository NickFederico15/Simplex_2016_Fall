...
void Application::Display(void)
{
	...
	matrix4 rotationX = glm::rotate(IDENTITY_M4, m_v3Rotation.x, vector3(1.0f, 0.0f, 0.0f));
	matrix4 rotationY = glm::rotate(IDENTITY_M4, m_v3Rotation.y, vector3(0.0f, 1.0f, 0.0f));
	matrix4 rotationZ = glm::rotate(IDENTITY_M4, m_v3Rotation.z, vector3(0.0f, 0.0f, 1.0f));
	matrix4 rotationMatrix = glm::rotate(IDENTITY_M4, 60.0f, vector3(0.0f, 0.0f, 1.0f));

	quaternion quat1 = glm::angleAxis(m_v3Rotation.x, vector3(1.0f, 0.0f, 0.0f));
	quaternion quat2 = glm::angleAxis(m_v3Rotation.y, vector3(0.0f, 1.0f, 0.0f));
	quaternion quat3 = glm::angleAxis(m_v3Rotation.z, vector3(0.0f, 0.0f, 1.0f));
	matrix4 m4Model = ToMatrix4(quat1 * quat2 * quat3);
